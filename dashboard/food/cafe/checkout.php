...
<div class="last" style="font-family: 'Bree Serif', serif;display: flex;align-items: center;justify-content: center;height: 40px;color: #ffffff;background: rgb(0, 0, 0);opacity: 0.5;padding: 5px;
}">
