...
<body>
        ...
        <div class="list-group rounded-0">
            ...
            <a href="customer.php" class="list-group-item list-group-item-action active border-0 align-items-center">
            <div>
                <span class="bi bi-cart-dash"></span>
        ...
        <main class="p-4 min-vh-100">
            ...
            <div class="col-md-6 col-lg-4">
                <!-- card -->
                <article class="p-4 rounded shadow-sm border-left mb-4 mysel2">
            ...
            <div class="col-md-6 col-lg-4">
                <article class="p-4 rounded shadow-sm border-left mb-4 mysel" style="background-color: #007bff;">
                <a href="customer.php" class="d-flex align-items-center cuscol">
                    <span class="bi bi-person h5" style="color: white;"></span>
                    <h5 class="ml-2" style="color: white;">Customers</h5>
                </a>
                </article>
            </div>
            <!-- <div class="col-md-6 col-lg-4">
